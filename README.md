...
Детали: Скрипт работает только с элементом Текст на чертеже. Он перебирает выделенные пользователем листы, находит все тексты и заменяет им параметры. \*Примечание: шрифты внутри Спецификаций, Таблиц, Рамок (штампов) и Меток не заменяются из-за ограничений архитектуры Renga API.  
...
❗ Из-за ограничений Renga API редактирование отметки уровня заблокировано.  
